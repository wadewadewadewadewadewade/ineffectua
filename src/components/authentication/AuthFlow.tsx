...
const AuthenticationStepOne = () => {
  ...
  return (
    <View style={styles.content}>
      ...
      />}
      {isRegister && (
        <Text>A link will be emailed to the address you enter above that will let you complete account creation.</Text>
      )}
      {error !== undefined ? (
      ...
      <Button
        ...
        style={styles.button}>
        <Text>Sign {isRegister ? 'Up' : 'In'}</Text>
      </Button>
      {isRegister ? (
      ...
      {isRegister && (<Text style={styles.smallprint}>
  ...
  if (!user) {
    ...
    return (
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          To complete your account creation, please {needs.displayName && 'select your name and '}enter the
          password you'd like to use when signing in{needs.photoURL && ', and enter a URL for your profile picture if you want to'}.
        </Text>
        {needs.displayName && (
          <TextInput
            placeholder="Name"
...
const SignInScreen = () => {
  ...
  if (user !== false && !user.isVerified) {
    return <AuthenticationStepTwo />;
  } else {
    return <AuthenticationStepOne/>;
  }
};
