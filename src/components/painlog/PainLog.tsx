  ...
  return (
    <ScrollView contentContainerStyle={{marginVertical:'auto'}}>
      <View style={styles.container}>
        <Svg x="0px" y="0px" viewBox="290 0 420 1000" enable-background="new 290 0 420 1000" style={styles.figure}>
