...
export const PainLog = ({
  ...
  const addLocation = (e: GestureResponderEvent, isBack: boolean = false) => {
    const { width, height } = isBack ? figureBackDimensions : figureFrontDimensions
    ...
    <View>
      <ScrollView centerContent={true}>
        ...
        <View style={styles.container}>
          ...
          <View
              onLayout={(e: LayoutChangeEvent) => setFigureBackDimensions(e.nativeEvent.layout)}
              onTouchStart={(e) => addLocation(e, true)}
              style={styles.touchablefigure}
          >
            <Svg
                style={{...styles.figure, ...adjustForDesktop}}
